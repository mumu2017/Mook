...
// 稍微延长了一点动画时间
#define kAnimationDurationForSectionCount(count) MAX(0.3f, MIN(count*0.15f, 0.5f))
...
// 在源文件的基础上做了改动:主要是JGActionSheetButtonStyleDefault和JGActionSheetButtonStyleCancel两个地方
...
- (CGRect)layoutForWidth:(CGFloat)width {
    CGFloat buttonHeight = 44.0f;   //按钮的高度
    CGFloat spacing = kSpacing;     //按钮的间隔
