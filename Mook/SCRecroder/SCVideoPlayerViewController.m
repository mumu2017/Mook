...
- (void)viewDidLoad
{
    ...
    [self.saveButton addTarget:self action:@selector(saveToCameraRoll) forControlEvents:UIControlEventTouchUpInside];
...
- (void)saveToCameraRoll {
    ...
    [exportSession exportAsynchronouslyWithCompletionHandler:^{
        ...
        if (exportSession.cancelled) {
            ...
            CLRecorderNavVC *nav = (CLRecorderNavVC *)self.navigationController;
            nav.block(exportSession.outputUrl, nil);
