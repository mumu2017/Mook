...
-(void)setupUI{
    ...
    [addButton setImage:kTagAddImage forState:UIControlStateNormal];
...
- (void)addButtonClicked {
    if ([self.tagDelegate respondsToSelector:@selector(tagFieldAddButtonClicked:)]) {
        [self.tagDelegate tagFieldAddButtonClicked:self];
    }
}
