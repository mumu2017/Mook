...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$CONFIGURATION_BUILD_DIR/DZNWebViewController/DZNWebViewController.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/EAIntroView/EAIntroView.framework"
  install_framework "$CONFIGURATION_BUILD_DIR/EARestrictedScrollView/EARestrictedScrollView.framework"
